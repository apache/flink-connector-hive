    ...
    static boolean isVersionNoLess(String version, String target) {
        ...
        if (m.find()) {
            ...
            while (i < versionArray.length && i < targetVersionArray.length) {
                int versionNo = Integer.valueOf(versionArray[i]);
                int targetVersionNo = Integer.valueOf(targetVersionArray[i]);
                if (versionNo == targetVersionNo) {
                    i++;
                } else {
                    return versionNo > targetVersionNo;
                }
            }
